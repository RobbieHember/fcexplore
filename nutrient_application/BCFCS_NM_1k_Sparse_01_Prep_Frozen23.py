...
meta=gu.ipickle(r'D:\Data\FCI_Projects\BCFCS_NM_1k_Sparse\Inputs\Metadata.pkl')

flg=0
if flg==1:
    meta['Paths']['Project']=r'D:\Data\FCI_Projects\BCFCS_NM_1k_Sparse'
    gu.opickle(r'D:\Data\FCI_Projects\BCFCS_NM_1k_Sparse\Inputs\Metadata.pkl',meta)
